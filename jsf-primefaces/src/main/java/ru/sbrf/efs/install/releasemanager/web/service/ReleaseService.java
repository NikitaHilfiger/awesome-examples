...
public class ReleaseService {
    ...
    @Autowired
    public ReleaseService(ArtifactService artifactService) {
        this.artifactService = artifactService;

        this.mockReleases = new ArrayList<Release>() {{
            add(
                    Release.builder()
                            .id("LLMH98")
                            .name("payment-fp")
                            ...
                            .artifact(artifactService.getMockArtifacts().get(0))
        ...
        this.ceNames = mockReleases.stream().map(
    ...
    private List<Release> mockReleases;
